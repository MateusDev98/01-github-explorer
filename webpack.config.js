...
module.exports = {
  ...
  entry: path.resolve(__dirname, "src", "index.tsx"), // Arquivo principal da nossa aplicação (index.jsx), __dirname pega o diretório onde está o meu arquivo wepack.config, ou seja ele sempre pega o diretório do arquivo que adicionei a instrução (__dirname)
  output: {
  ...
  resolve: {
    extensions: [".js", ".jsx", ".ts", ".tsx"], // Define quais arquivos o webpack pode ler por meio de sua extensão
  },
  devServer: {
